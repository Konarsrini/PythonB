...
x[-12] is a
x[0:3] is abc
x[0:11] is abcdefghijkl
x[0:13] is abcdefghijkl
x[11] is l
x[12] is Error
x[1:2] is b
x[1:4] is bcd
...
print(strString1 + ' everybody ' + strString2+' '+str(intVariaon)+' and '+str(int)+' was up.')#Hello everybody there 348 and 345 was up.
#==============Escape characters===============================
txt = "(1)We are the so called \"Vikings\" from the north"
print(txt)#(1)We are the so called "Vikings" from the north
#\'
print('(2)We are the so called \'Vikings\' from the north')
#(2)We are the so called 'Vikings' from the north
print("This will insert one \\ backslash")
#This will insert one \ backslash
print("This will print in \nnext line")
#This will print in 
#next line
print("This will carriage return \rnext line")
#This will carriage return 
#next line
print("This will insert tab\tnext line")#This will insert tab	next line
print("This will erase \bone character back space ")
#\f : form feed
#\ooo: ocatal value
#xhh: Hex value