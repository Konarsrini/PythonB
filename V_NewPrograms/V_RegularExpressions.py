...
x1A = re.search("in", txt)
print("x1A: " + str(x1A))
# x1A: <re.Match object; span=(6, 8), match='in'>
#====================
# findall-Returns a list containing all matches
txt = "The rain in Spain"
x1B = re.findall("in", txt)
print("x1B: " + str(x1B))
#x1B: ['in', 'in', 'in']
#====================
...
txt = "The rain in Spain"
x1D = re.sub("in", "ww", txt)
print("x1D: " + str(x1D))
# x1D: The raww ww Spaww
#====================
x1 = re.search("^The.*Spain$", txt)
print("x1: " + str(x1))
# x1: <re.Match object; span=(0, 17), match='The rain in Spain'>
x2 = re.search("^The", txt)
print("x2: " + str(x2))
# x2: <re.Match object; span=(0, 3), match='The'>
x2A = re.search("Thou", txt)
print("x2A: " + str(x2A))
#x2A: None

# findall-Returns a list containing all matches
x3 = re.findall("pain", txt)
print("x3: " + str(x3))
#x3: ['pain']
x4 = re.findall("twain", txt)
print("x4: " + str(x4))
#x4: []
"""
RegEx Functions
...
import re
"""
txt = "The rain in Spain amounts to 5 inches"
x5 = re.findall("ai", txt)
x5A = re.findall("[a-i]", txt)
#x5A: ['h', 'e', 'a', 'i', 'i', 'a', 'i']
x5A1 = re.findall("paranyata", txt)
#x5A1: []
x5A2 = re.findall("Spain", txt)
#x5A2: ['Spain']
x5A3 = re.search("Spain", txt)
print("x5A3: " + str(x5A3))
# x5A3: <re.Match object; span=(12, 17), match='Spain'>
x5A4 = re.search("paint", txt)
print("x5A4: " + str(x5A4))
#x5A4: None
x5B = re.findall("[a-z]", txt)
#x5B: ['h', 'e', 'r', 'a', 'i', 'n', 'i', 'n', 'p', 'a', 'i', 'n']
x5C = re.findall("r..n", txt)
#x5C: ['rain']
x5D = re.findall("^The", txt)
#x5D: ['The']
x5E = re.findall("Spain$", txt)
#x5E: ['Spain']
x5F = re.findall("Spn+", txt)
#x5F: []
x5G = re.findall("in*", txt)
#x5G: ['in', 'in', 'in']
x5H = re.findall("in{2}", txt)
#x5H: ['in', 'in', 'in']
x5I = re.findall("rain|Spain|on", txt)
#x5I: ['rain', 'Spain']
x5J = re.findall("\Arain", txt)
#x5J: []
x5K = re.findall("\AThe", txt)
#x5K: ['The']
x5L = re.findall("\Bhe", txt)
#x5L: ['he']
x5M = re.findall("\d", txt)
#x5M: ['5']
x5N = re.findall("\D", txt)
#x5N: ['T', 'h', 'e', ' ', 'r', 'a', 'i', 'n', ' ', 'i', 'n', ' ', 'S', 'p', 'a', 'i', 'n', ' ', 'a', 'm', 'o', 'u', 'n', 't', 's', ' ', 't', 'o', ' ', ' ', 'i', 'n', 'c', 'h', 'e', 's']
x5O = re.findall("\s", txt)
#x5O: [' ', ' ', ' ', ' ', ' ', ' ', ' ']
x5P = re.findall("\S", txt)
#x5P: ['T', 'h', 'e', 'r', 'a', 'i', 'n', 'i', 'n', 'S', 'p', 'a', 'i', 'n', 'a', 'm', 'o', 'u', 'n', 't', 's', 't', 'o', '5', 'i', 'n', 'c', 'h', 'e', 's']
x5Q = re.findall("\w", txt)
#x5Q: ['T', 'h', 'e', 'r', 'a', 'i', 'n', 'i', 'n', 'S', 'p', 'a', 'i', 'n', 'a', 'm', 'o', 'u', 'n', 't', 's', 't', 'o', '5', 'i', 'n', 'c', 'h', 'e', 's']
x5R = re.findall("inches\Z", txt)
#x5R: ['inches']
x5S = re.findall("[arn]", txt)
#x5S: ['r', 'a', 'n', 'n', 'a', 'n', 'a', 'n', 'n']
x5U = re.findall("[^arn]", txt)
#x5U: ['T', 'h', 'e', ' ', 'i', ' ', 'i', ' ', 'S', 'p', 'i', ' ', 'm', 'o', 'u', 't', 's', ' ', 't', 'o', ' ', '5', ' ', 'i', 'c', 'h', 'e', 's']
x5T = re.findall("[a-p]", txt)
#x5T: ['h', 'e', 'a', 'i', 'n', 'i', 'n', 'p', 'a', 'i', 'n', 'a', 'm', 'o', 'n', 'o', 'i', 'n', 'c', 'h', 'e']
x5V = re.findall("[0123]", txt)
#x5T: ['h', 'e', 'a', 'i', 'n', 'i', 'n', 'p', 'a', 'i', 'n', 'a', 'm', 'o', 'n', 'o', 'i', 'n', 'c', 'h', 'e']
x5W = re.findall("[0-9]", txt)
#x5W: ['5']
x5X = re.findall("[0-5][0-9]", txt)
#x5X: []
x5Y = re.findall("[a-z]", txt)
# x5Y:x5Y: ['h', 'e', 'r', 'a', 'i', 'n', 'i', 'n', 'p', 'a', 'i', 'n', 'a', 'm', 'o', 'u', 'n', 't', 's', 't', 'o', 'i', 'n', 'c', 'h', 'e', 's']
x5Y1 = re.findall("[A-Z]", txt)
#x5Y1: ['T', 'S']
print(re.findall('[^a-zA-Z0-9]',txt))#Any Wild Character search
"""
[+] In sets, +, *, ., |, (), $,{} has no special meaning, so [+] means: return a match for any + character in the string    
"""
x9 = re.split("\s", txt)
#x9: ['The', 'rain', 'in', 'Spain', 'amounts', 'to', '5', 'inches']
x9A = re.split("\s", txt, 2)
#x9A: ['The', 'rain', 'in Spain amounts to 5 inches']
x10A = re.sub("\s", "9", txt)
#x10A: The9rain9in9Spain9amounts9to959inches
x10B = re.sub("\s", "9", txt, 2)
# x10B: The9rain9in Spain amounts to 5 inches
print("x10B: " + str(x10B))
print("x10A: " + str(x10A))
print("x9A: " + str(x9A))
print("x9: " + str(x9))
...
txt = "The rain in Spain"
x7 = re.search("\s", txt)
print("The first whiThe first white-space character is located in position: 3te-space character is located in position:", x7.start())
